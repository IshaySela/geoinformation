...
export default function CreateNewPoiForm(props: CreateNewPoiFormProps): JSX.Element {
    ...
    return <>
        <Form
            ...
            {
                props.id ? <Field.Root className="flex flex-col items-start gap-1" name="id">
            ...
            <Field.Root className="flex flex-col items-start gap-1" name={NAME_FIELD}>
            ...
            <Field.Root className="flex flex-col items-start gap-1" name={DESCRIPTION_FIELD}>
            ...
            <Field.Root className="flex flex-col items-start gap-1" name={CATEGORY_FIELD}>
            ...
            <Field.Root className="flex flex-col items-start gap-1" name={LAT_FIELD}>
            ...
            <Field.Root className="flex flex-col items-start gap-1" name={LNG_FIELD}>
