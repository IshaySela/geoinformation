import { useState, type FormEvent as ChangeEvent, type JSX } from "react";
    ...
    return <>
        <Form
            ...
            <Field.Root name={NAME_FIELD}>
                ...
                <Field.Control value={formState.name} onChange={e => { setFormState({ ...formState, name: e.currentTarget.value }) }} type="text" required className={inputClass} />
            ...
            <Field.Root name={DESCRIPTION_FIELD}>
                ...
                <Field.Control onChange={e => { setFormState({ ...formState, description: e.currentTarget.value }) }} value={formState.description} type="text" required className={inputClass} />
                <Field.Error className={errorClass} />
            </Field.Root>

            <Field.Root name={CATEGORY_FIELD}>
                <Field.Label className={labelClass}>Category</Field.Label>
                <Field.Control value={formState.category} onChange={e => { setFormState({ ...formState, category: e.currentTarget.value }) }} type="text" required className={inputClass} />
                <Field.Error className={errorClass} />
            </Field.Root>
